...
namespace PagoElectronico.UI.ABM_Cliente
{
    public partial class SeleccionarCliente : Form
    {
        ...
        {
            this.darDeBajaButton.Enabled = false;
        ...
        private void darDeBajaButton_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show("Esta seguro que quiere dar de baja este Cliente?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
